...
- `opsx:propose` — 开发代表 引用
- `superpowers:writing-plans` — 开发代表 引用
- `superpowers:executing-plans` — 后端开发、前端开发 引用
- `superpowers:test-driven-development` — 后端开发、整体测试 引用
- `superpowers:systematic-debugging` — 后端开发、代码审计师、整体测试 引用
- `vue-skills-bundle:vue-best-practices` — 前端开发 引用
- `vue-skills-bundle:vue-pinia-best-practices` — 前端开发 引用
- `frontend-design:frontend-design` — 前端开发 引用
...
3. 询问格式示例：
   ...
   - opsx:propose (开发代表 需要)
   - superpowers:executing-plans (后端开发/前端开发 需要)
...
从本技能的 `_agents/` 目录拷贝 6 个 Agent 配置文件到 `.claude/agents/`。
...
|--------|---------|-------|------|------|
| `_agents/planner.md` | `.claude/agents/planner.md` | 开发代表 | sonnet | cyan |
| `_agents/backend-developer.md` | `.claude/agents/backend-developer.md` | 后端开发 | sonnet | green |
| `_agents/frontend-developer.md` | `.claude/agents/frontend-developer.md` | 前端开发 | sonnet | yellow |
| `_agents/verifier.md` | `.claude/agents/verifier.md` | 代码审计师 | haiku | purple |
| `_agents/api-test.md` | `.claude/agents/api-test.md` | 接口测试 | sonnet | blue |
| `_agents/tester.md` | `.claude/agents/tester.md` | 整体测试 | haiku | red |
...
读取 `.claude/agents/` 下的 6 个文件（第一阶段已确保它们存在），对比梳理出的信息与现有 Agent 配置的差异：
- 技术栈是否与项目实际一致？
- 代码规范是否涵盖了项目已有的惯例？
